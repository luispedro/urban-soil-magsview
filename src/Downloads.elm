module Downloads exposing (mkFASTALink, mkENOGLink, mkEMapperSummaryLink, mkBarrnapLink)
...
mkBarrnapLink mid =
    "https://sh-dog-mags-data.big-data-biology.org/ShanghaiDogsMAGAnnotations/Barrnap/" ++ mid ++ "_ribosomal.fna.gz"
